...
echo "================================================================================"
echo
echo "Your machine is all set with the common tools used across our teams. Depending"
echo "on what projects you will be working on you may want to run one of the following"
